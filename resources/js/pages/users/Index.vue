...
import { create, index, edit, destroy  } from '@/routes/users';
...
const columns = [
    ...
    }, name: 'created_at', title: 'Date Time Created', className: 'text-center' },
    {
        data: null, 
        render: '#actions', 
        title: '',
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs"> 
        <div class="p-4">
            ...
            <DataTable :columns="columns" class="display max-w-full text-center" :options="{
                ajax: apiIndex().url,
                serverSide: true,
                processing: true,
                searching: true,
                ...
                <template #actions="{ rowData }">
                    <div class="flex justify-center">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent>
                                <DropdownMenuItem>
                                    <Link :href="edit(rowData.id)" class="flex w-full items-center">
                                        <PencilIcon class="mr-2 h-4 w-4" /> Edit
                                    </Link>
                                </DropdownMenuItem>
                                <DropdownMenuItem variant="destructive">
                                    <Link :href="destroy(rowData.id)" class="flex w-full items-center">
